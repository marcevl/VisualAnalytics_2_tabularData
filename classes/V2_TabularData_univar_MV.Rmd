...
h1= h1 + stat_bin(binwidth = 20, aes(label=..count..), #aes...don't change
...
# strategy 1: remove missing before computing function: na.rm=T (RECOMMENDED OPTION)
...
plot(mvDense,main="Teacher-student ratio per county",col='black',xlab=NA)
